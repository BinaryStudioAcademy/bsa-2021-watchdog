...
namespace Watchdog.Core.DAL.Context
{
    public static class ModelBuilderExtensions
    {
        ...
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PlatformType>().HasData(GeneratePlatformTypes());
            modelBuilder.Entity<Platform>().HasData(GeneratePlatforms());
            modelBuilder.Entity<PlatformsPlatformsType>().HasData(GeneratePlatformsPlatformsType());
        ...
        private static IList<PlatformType> GeneratePlatformTypes()
        {
            return new List<PlatformType>
            {
                new PlatformType { Id = 1, Name = "browser" },
                new PlatformType { Id = 2, Name = "server" },
                new PlatformType { Id = 3, Name = "mobile" },
                new PlatformType { Id = 4, Name = "desktop" },
            };
        }
...
/*                new Platform
        ...
        private static IList<PlatformsPlatformsType> GeneratePlatformsPlatformsType()
        {
            const int browser = 1, server = 2, mobile = 3, desktop = 4;
            return new List<PlatformsPlatformsType>
            {
                new PlatformsPlatformsType { PlatformId = 1, PlatformTypeId = mobile },
                new PlatformsPlatformsType { PlatformId = 2, PlatformTypeId = mobile },
                new PlatformsPlatformsType { PlatformId = 3, PlatformTypeId = server },
                new PlatformsPlatformsType { PlatformId = 3, PlatformTypeId = desktop },
                new PlatformsPlatformsType { PlatformId = 4, PlatformTypeId = server },
                new PlatformsPlatformsType { PlatformId = 5, PlatformTypeId = mobile },
                new PlatformsPlatformsType { PlatformId = 6, PlatformTypeId = server },
                new PlatformsPlatformsType { PlatformId = 7, PlatformTypeId = server },
                new PlatformsPlatformsType { PlatformId = 7, PlatformTypeId = browser },
                new PlatformsPlatformsType { PlatformId = 8, PlatformTypeId = server },
                new PlatformsPlatformsType { PlatformId = 8, PlatformTypeId = desktop },
                new PlatformsPlatformsType { PlatformId = 9, PlatformTypeId = browser },
                new PlatformsPlatformsType { PlatformId = 10, PlatformTypeId = browser },
                new PlatformsPlatformsType { PlatformId = 11, PlatformTypeId = browser },
                new PlatformsPlatformsType { PlatformId = 12, PlatformTypeId = browser },
                new PlatformsPlatformsType { PlatformId = 13, PlatformTypeId = browser },
                new PlatformsPlatformsType { PlatformId = 14, PlatformTypeId = server },
                new PlatformsPlatformsType { PlatformId = 15, PlatformTypeId = server },
                new PlatformsPlatformsType { PlatformId = 16, PlatformTypeId = browser },
            };
        }
